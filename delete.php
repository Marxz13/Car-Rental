...
<body>
    ...
    <div class="popup-delete center">
      <div class="close-icon"><a href="index.php">&#x2715;</a></div>
        ...
        <div class="title">
          Enter Your Reservation ID (Delete)
          <form method="post" action="delete.php">
          <input type="number" name="reservation-id"></input>
          <input id="open-description-btn" type="submit" name="submit-delete" value="Search"></input>
          </form>
        </div>
          ...
          <div class="description-inner">
            <?php
              ...
              if(isset($_POST['submit-delete']))
              {
                ...
                {
                  //store user input and retrieve reservation details using user's input
        ...
        <?php   }
            ...
            } else { //if user does not input anything, prompt them to input the correct ID again.
      ...
      <!-- Only shows when user input the correct reservation ID-->
      <div class="dismiss-btn"<?php if (!isset($_POST['submit-delete']) || $reservations === FALSE) { echo ' style="display: none"'; } ?>>
      <form action="delete.php" method="post">
        <button id="dismiss-popup-btn" name="delete-button">
          Delete
        </button>
      </form>
      </div>
      <?php
        //if user clicks 'delete', delete the reservation.
        if (isset($_POST['delete-button']))
        {
          deleteReservation($conn, $_SESSION['id']);
        }
